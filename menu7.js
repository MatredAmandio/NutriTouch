...
(function(){
  ...
  function renderMenu7(){
    ...
    baseDay.meals.slice(0,nMeals).forEach((m,i)=>{
      ...
      const carb=items.filter(([n])=>['Arroz branco cozido','Batata cozida','Aveia em flocos','Pão integral','Tapioca','Feijão cozido','Banana','Maçã'].includes(n));
